...
!(function() {
  ...
  (t.version = '0.7.1'),
    ...
    (t.SortedSet.prototype.intersect = function(e) {
      for (
        var n = new t.SortedSet(), i = 0, r = 0, o = this.length, s = e.length, a = this.elements, h = e.elements;
        ;
    ...
    (t.Index.prototype.tokenizer = function(e) {
      ...
      return (
        n || t.utils.warn('Function is not a registered tokenizer. This may cause problems when serialising the index'),
        (this.tokenizerFn = e),
        this
      );
    }),
          ...
          if (
            ...
            (i = T[1]),
              ...
              a.test(i) &&
                ...
                (h = w),
                (u = k),
                a.test(n) ? (n += 'e') : h.test(n) ? ((s = y), (n = n.replace(s, ''))) : u.test(n) && (n += 'e'));
          }
          if (((s = x), s.test(n))) {
            var T = s.exec(n);
            (i = T[1]), (n = i + 'i');
