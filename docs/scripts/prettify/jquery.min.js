...
(function(e, undefined) {
  ...
  (x.fn = x.prototype = {
    ...
    init: function(e, t, n) {
      ...
      if ('string' == typeof e) {
        if (
          ((r = '<' === e.charAt(0) && '>' === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : T.exec(e)),
          !r || (!r[1] && t))
        )
            ...
            (n = s[t]),
              ...
              s !== r &&
                (l && r && (x.isPlainObject(r) || (i = x.isArray(r)))
                  ? (i ? ((i = !1), (o = n && x.isArray(n) ? n : [])) : (o = n && x.isPlainObject(n) ? n : {}),
                    (s[t] = x.extend(l, o, r)))
                  : r !== undefined && (s[t] = r));
      return s;
    }),
          ...
          return t !== c && 9 === t.nodeType && t.documentElement
            ? ((c = t),
              ...
              b.getById
                ...
                : ((r.find.ID = function(e, t) {
                    if (typeof t.getElementById !== j && p) {
                      var n = t.getElementById(e);
                      return n
                        ? n.id === e || (typeof n.getAttributeNode !== j && n.getAttributeNode('id').value === e)
                          ? [n]
                          : undefined
                        : [];
                    }
              ...
              (b.matchesSelector = it(
                (g = f.webkitMatchesSelector || f.mozMatchesSelector || f.oMatchesSelector || f.msMatchesSelector)
              )) &&
                at(function(e) {
      ...
      function gt(e, t) {
        ...
        while (a) {
          (!n || (i = z.exec(a))) && (i && (a = a.slice(i[0].length) || a), u.push((o = []))),
            (n = !1),
            (i = _.exec(a)) &&
              ((n = i.shift()), o.push({ value: n, type: i[0].replace(I, ' ') }), (a = a.slice(n.length)));
          for (s in r.filter)
            !(i = G[s].exec(a)) ||
              (l[s] && !(i = l[s](i))) ||
    ...
    addClass: function(e) {
      ...
      if (u)
        for (t = (e || '').match(w) || []; a > s; s++)
          if (
            ((n = this[s]), (r = 1 === n.nodeType && (n.className ? (' ' + n.className + ' ').replace(W, ' ') : ' ')))
          ) {
            o = 0;
      ...
      attr: function(e, t, n) {
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return typeof e.getAttribute === r
            ? x.prop(e, t, n)
            : ((1 === s && x.isXMLDoc(e)) ||
                ((t = t.toLowerCase()), (i = x.attrHooks[t] || (x.expr.match.boolean.test(t) ? M : R))),
              n === undefined
      ...
      if (m && (u = m.events)) {
        ...
        while (l--)
          if (((a = X.exec(t[l]) || []), (h = g = a[1]), (d = (a[2] || '').split('.').sort()), h)) {
            ...
            s &&
              !p.length &&
              ((f.teardown && f.teardown.call(e, d, m.handle) !== !1) || x.removeEvent(e, h, m.handle), delete u[h]);
    ...
    x.extend({
      ...
      buildFragment: function(e, t, n, r) {
        ...
        while ((i = h[c++]))
          if (
            (!r || -1 === x.inArray(i, r)) &&
            ((u = x.contains(i.ownerDocument, i)), (o = gt(p.appendChild(i), 'script')), u && ht(o), n)
          ) {
            l = 0;
        ...
        r.style &&
          ...
          t
            ? (o[s] || 'none' !== n || (r.style.display = ''),
              '' === r.style.display && At(r) && (o[s] = q.access(r, 'olddisplay', Pt(r.nodeName))))
            : o[s] ||
              ((i = At(r)), ((n && 'none' !== n) || !i) && q.set(r, 'olddisplay', i ? n : x.css(r, 'display'))));
    for (s = 0; a > s; s++)
      (r = e[s]),
        r.style &&
      ...
      'margin' === n && (s += x.css(e, n + St[o], !0, i)),
        r
          ? ('content' === n && (s -= x.css(e, 'padding' + St[o], !0, i)),
            'margin' !== n && (s -= x.css(e, 'border' + St[o] + 'Width', !0, i)))
  ...
  function Pt(e) {
    ...
    return (
      n ||
        ...
        ('none' !== n && n) ||
          ((vt = (
            vt || x("<iframe frameborder='0' width='0' height='0'/>").css('cssText', 'display:block !important')
      ...
      ajax: function(e, t) {
        ...
        if (
          ...
          null == c.crossDomain &&
            ...
            (c.crossDomain = !(
              ...
              (a[1] === _t[1] &&
                a[2] === _t[2] &&
                (a[3] || ('http:' === a[1] ? '80' : '443')) === (_t[3] || ('http:' === _t[1] ? '80' : '443')))
            ))),
        ...
        (u = c.global),
          ...
          c.hasContent ||
            ...
            c.cache === !1 &&
              (c.url = Gt.test(r) ? r.replace(Gt, '$1_=' + Ut++) : r + (Yt.test(r) ? '&' : '?') + '_=' + Ut++)),
          c.ifModified &&
          ...
          T.setRequestHeader(
            ...
            c.dataTypes[0] && c.accepts[c.dataTypes[0]]
              ? c.accepts[c.dataTypes[0]] + ('*' !== c.dataTypes[0] ? ', ' + on + '; q=0.01' : '')
              : c.accepts['*']
          );
      ...
      return a || 'jsonp' === t.dataTypes[0]
        ? ((i = t.jsonpCallback = x.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
          a
            ...
            : t.jsonp !== !1 && (t.url += (Yt.test(t.url) ? '&' : '?') + t.jsonp + '=' + i),
          ...
          function(t, i, o) {
            ...
            return o === undefined
              ? s
                ? s[n]
                : t[i]
              : (s ? s.scrollTo(r ? e.pageXOffset : o, r ? o : e.pageYOffset) : (t[i] = o), undefined);
          },
          t,
          i,
          arguments.length,
