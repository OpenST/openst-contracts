...
npm install @ostdotcom/ost-price-oracle@1.0.5-beta.2 --save-dev
cd ../../node_modules/@ostdotcom/ost-price-oracle/
echo "\n********* Done *************"

echo "\n********* Deploying PO 1 *************"
node ./tools/deploy/price_oracle.js OST USD 0x12A05F200 travis po1.txt $PRICE_ORACLE_CONFIG_STRATEGY_FILE_NAME
echo "\n********* Done *************"
echo "\n********* Deploying PO 2 *************"
node ./tools/deploy/price_oracle.js OST EUR 0x12A05F200 travis po2.txt $PRICE_ORACLE_CONFIG_STRATEGY_FILE_NAME
echo "\n********* Done *************"
echo "\n********* Deploying PO 3 *************"
node ./tools/deploy/price_oracle.js OST INR 0x12A05F200 travis po3.txt $PRICE_ORACLE_CONFIG_STRATEGY_FILE_NAME
echo "\n********* Done *************"
echo "\n********* Deploying PO 4 *************"
node ./tools/deploy/price_oracle.js ETH USD 0x12A05F200 travis po4.txt $PRICE_ORACLE_CONFIG_STRATEGY_FILE_NAME
echo "\n********* Done *************"
