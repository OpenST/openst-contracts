...
describe('Pay', function() {
  ...
  it('should pass when all parameters are valid', async function() {
    ...
    assert.equal(
      ...
      'account1: Actual and cacheValue mismatch'
    );
    assert.equal(
      initialAccount3Balance.toNumber(),
      initialAccount3BalanceCache.toNumber(),
      'account3: Actual and cacheValue mismatch'
    );
    assert.equal(
      initialAccount4Balance.toNumber(),
      initialAccount4BalanceCache.toNumber(),
      'account4: Actual and cacheValue mismatch'
    );
    ...
    assert.equal(
      account1Balance.toNumber(),
      finalAccount1BalanceCache.toNumber(),
      'account1: Actual and cacheValue mismatch after test'
    );
    assert.equal(
      account3Balance.toNumber(),
      finalAccount3BalanceCache.toNumber(),
      'account3: Actual and cacheValue mismatch after test'
    );
    assert.equal(
      account4Balance.toNumber(),
      finalAccount4BalanceCache.toNumber(),
      'account4: Actual and cacheValue mismatch after test'
    );
  });
  ...
  it('should fail when intendedPricePoint is more than the acceptable margin of current price point', async function() {
    ...
    const changedPricePoint = new BigNumber(intendedPricePoint).plus(estimatedMargin).plus(new BigNumber(1));
  ...
  it('should fail when intendedPricePoint is less than the acceptable margin of current price point', async function() {
    ...
    const changedPricePoint = new BigNumber(intendedPricePoint).minus(estimatedMargin).minus(new BigNumber(1));
