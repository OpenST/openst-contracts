...
SetWorkerOps.prototype = {
  ...
  perform: async function(options) {
    const oThis = this,
      ...
      manifest = oThis.ic().getServiceManifest(),
      SetOpsKlass = manifest.opsManaged.setOps,
      GetOpsKlass = manifest.opsManaged.getOps,
      DeployWorkersKlass = manifest.deploy.workers;
...
InstanceComposer.registerShadowableClass(SetWorkerOps, 'getSetWorkerOpsClass');
