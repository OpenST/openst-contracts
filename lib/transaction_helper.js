...
TransactionHelper.prototype = {
  ...
  beforeAirdropPay: function(
    ...
    // TODO:
    // total amount to debit from spenders account = estimatedPayAmount - estimatedAirdropAmount
    // Airdrop budget holder debit => estimatedAirdropAmount
  ...
  afterAirdropPaySuccess: function(
    ...
    const allPromises = [adjustmentAirdropBalancePromise];
