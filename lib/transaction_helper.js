...
TransactionHelper.prototype = {
  ...
  beforePay: function(brandedTokenAddress, spender, estimatedPayAmount) {
    ...
    return oThis.pessimisticDebit(brandedTokenAddress, spender, estimatedPayAmount);
  },
   ...
   *
   */
  afterPaySuccess_back: async function(brandedTokenAddress, spender, estimatedPayAmount, beneficiaryAddress,
  ...
  afterPayFailure: function (brandedTokenAddress, spender, estimatedPayAmount) {
    ...
    estimatedPayAmount = basicHelper.convertToBigNumber(estimatedPayAmount).mul(basicHelper.convertToBigNumber(-1));
