...
setup.prototype = {
    ...
    validateParams: function(){
      ...
      return new Promise(async function (onResolve, onReject) {
        ...
        if (airdropRecord){
          return onResolve(responseHelper.error('l_am_s_vp_4', 'airdrop for given contract address is already setup'));
        }
