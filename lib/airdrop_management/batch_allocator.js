...
batchAllocator.prototype = {
  ...
  validateParams: function(){
    ...
    return new Promise(async function (onResolve, onReject) {
      ...
      if (oThis.totalAmountAfterAllocatingInputAmount > oThis.airdropAllocationProofDetailRecord['airdrop_amount']){
        return onResolve(responseHelper.error('l_am_ba_vp_11', 'oThis.totalAmountAfterAllocatingInputAmount is greater than transferred airdrop amount'));
      }
