...
register.prototype = {
    ...
    perform: async function () {
      ...
      logger.info("=======register.validateParams.result=======");
      logger.info(r);
      if(r.isFailure()) return r;

      r = await oThis.runRegister();
      logger.info("=======register.runRegister.result=======");
      logger.info(r);
      return r;
    ...
    validateParams: function(){
      ...
      return new Promise(async function (onResolve, onReject) {
        ...
        if (airdropRecord){
          return onResolve(responseHelper.error('l_am_s_vp_4', 'airdrop for given contract address is already register'));
        }
    ...
    runRegister: function(){
      ...
      return new Promise(async function (onResolve, onReject) {
        ...
        try {
          ...
          logger.info("========register.runRegister.airdropModelObject=======");
          logger.info(airdropModelObject);
          var airdropModel = new airdropKlass();
          const insertedRecord = await airdropModel.create(airdropModelObject);
          logger.info("========register.runRegister.insertedRecord=======");
          logger.info(insertedRecord);
