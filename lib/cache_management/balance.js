...
BalanceCache.prototype = {
  ...
  getBalance: function (owner) {
    ...
    //logger.debug('getBalance called with params:', JSON.stringify({owner: owner, cacheKey: cacheKey}));
  ...
  setBalance: function (owner, balance) {
    ...
    // logger.debug('setBalance called with params:', JSON.stringify({owner: owner, balance: balance.toString(10),
    //   cacheKey: cacheKey}));
