...
const AirdropModelCacheKlassPrototype = {
  ...
  setCacheKey: function() {
    ...
    oThis.cacheKey = oThis._cacheKeyPrefix() + "airdrop_"+oThis.contractAddress;
  ...
  fetchDataFromSource: function() {
    ...
    return new Promise(async function(onResolve, onReject){
      ...
      if (!airdropRecord){
        return onResolve(responseHelper.successWithData(null));
      }

      var formattedAirdropDetails = {};
      formattedAirdropDetails[airdropRecord.contract_address.toLowerCase()] = {id: airdropRecord.id};
