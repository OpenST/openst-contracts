...
const rootPrefix = '../..'
  ...
  /**
   ...
   Hence, dont worry, you dont need to use oThis.ic().getCacheManagementPricerKlass()
   **/
...
InstanceComposer.registerShadowableClass(AirdropBalanceCache, "getCacheManagementAirdropKlass");
