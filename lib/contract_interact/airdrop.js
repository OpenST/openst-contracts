...
const AirdropSpecificPrototype = {
  ...
  */
  _asyncPay: async function (senderWorkerAddress, senderWorkerPassphrase, beneficiaryAddress,
    ...
    oThis.airdropBudgetHolder = airdropBudgetHolder;
    ...
    if (!airdropBudgetHolder) {
      ...
      oThis.airdropBudgetHolder = airdropBudgetHolderResponse.data.airdropBudgetHolder;
    }
    ...
    const postPayParams = {
      ...
      airdropBudgetHolder: oThis.airdropBudgetHolder,
