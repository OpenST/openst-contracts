...
Airdrop.prototype.pay = async function (
  ...
  const successCallback = function(receipt) {
    return oThis.transactionHelper.updateBalanceCacheOnReceipt(oThis.brandedTokenAddress, totalAmount, senderWorkerAddress, beneficiaryAddress, commissionBeneficiaryAddress, receipt);
  };
