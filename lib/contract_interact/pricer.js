...
const Pricer = module.exports = function (pricerAddress, chainId) {
  ...
  oThis.conversionRateDecimals().then(function(response) {
    oThis.pricerConversionRateDecimals = response.data.conversionRateDecimals;
  });
...
Pricer.prototype = {
  ...
  pricerConversionRateDecimals: null,
  pricerDecimals: null,
  ...
  */
  pay: async function (
    ...
    return oThis.transactionHelper.debitBalance(
      oThis.brandedTokenAddress,
      senderAddress,
      totalAmount)
      .then(function(senderDebitCacheResponse) {
  ...
  */
  getEstimatedTotalAmount: function (transferAmount, commissionAmount, intendedPricePoint) {
    ...
    const pricerConversionRateDecimals = new BigNumber(oThis.pricerConversionRateDecimals);
  ...
  updateBalanceCacheOnReceipt: function(
    ...
    const creditBeneficiaryBalancePromise = new Promise(function (onResolve, onReject) {
      if (actualTransferAmount > 0) {
        oThis.transactionHelper.creditBalance(oThis.brandedTokenAddress, beneficiaryAddress, actualTransferAmount).then(function(beneficiaryCreditCacheResponse) {              
    ...
    const creditCommissionBeneficiaryBalancePromise = new Promise(function (onResolve, onReject) {
      if (actualCommissionAmount > 0) {
        oThis.transactionHelper.creditBalance(oThis.brandedTokenAddress, commissionBeneficiaryAddress, actualCommissionAmount).then(function(commissionBeneficiaryCreditCacheResponse) {              
    ...
    const adjustmentBalancePromise = new Promise(function (onResolve, onReject) {
      if (actualTotalAmount.gt(initialDebitAmount)) {
        ...
        oThis.transactionHelper.debitBalance(oThis.brandedTokenAddress, senderAddress, adjustedAmount).then(function(senderAdjustedCreditCacheResponse) {
        ...
        oThis.transactionHelper.creditBalance(oThis.brandedTokenAddress, senderAddress, adjustedAmount).then(function(senderAdjustedDebitCacheResponse) {
  ...
  */
  rollBackBalanceCache: function(senderAddress, totalAmount) {
    ...
    const oThis = this;
    return new Promise(function (onResolve, onReject) {
      oThis.transactionHelper.creditBalance(senderAddress, totalAmount).then(function(senderCreditCacheResponse) {
