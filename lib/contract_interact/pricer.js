...
Pricer.prototype = {
  ...
  */
  pay: async function (
    ...
    const successCallback = function(receipt) {
      return oThis.transactionHelper.updateBalanceCacheOnReceipt(oThis.brandedTokenAddress, totalAmount, senderAddress, beneficiaryAddress,
        commissionBeneficiaryAddress, receipt, oThis.addressToNameMap);
    };

    const failCallback = function(reason) {
      return oThis.transactionHelper.rollBackBalanceCache(oThis.brandedTokenAddress, senderAddress, totalAmount);
    };
